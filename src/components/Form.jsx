...
export default function Form({ onSubmit, loading }) {
  ...
  /* ── FIX: stable per-field refs declared individually at top level ── */
  ...
  const production_quantityRef = useRef(null)
  const market_priceRef        = useRef(null)
  const transport_modeRef      = useRef(null)
  const storage_typeRef        = useRef(null)
  ...
  const refs = {
    ...
    production_quantity: production_quantityRef,
    market_price:        market_priceRef,
    transport_mode:      transport_modeRef,
    storage_type:        storage_typeRef,
  }
